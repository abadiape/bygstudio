...
class Spots {
 ...
 echo "<li id=\"video$i\"><img src=\"http://bygstudio.com/$dire/$value\" onclick=\"playVideo(\'$dire/$videolist[$i]\',\'$i\')\"></li>";
        ...
        {
            $contentQuery = "SELECT content FROM pages_text WHERE name='services'"; 
...
<!-- Text -->
<h1>Contacts</h1>
<marquee class="left" behavior="slide" direction="up" width="233" height="340">
<p>CAMILO R. ABADIA<br />Post-Production Director<br /><a href="mailto:camilo.a@bygstudio.com">camilo.a@bygstudio.com</a><br /><br />
LUIS EDUARDO ABADIA<br />Manager and Marketing Director<br /><a href="mailto:eduardo.a@bygstudio.com">eduardo.a@bygstudio.com</a><br /><br />
LUISA FERNANDA HOYOS<br />Public Relations<br /><a href="mailto:luisa.h@bygstudio.com">luisa.h@bygstudio.com</a><br /></p></marquee>
<div class="right"><p>Prolongación Reforma 2000 P. 6, Col. Lomas de Santa Fé C.P. 01210, México D.F.
<br />Landline:+52 (55) 5255-2532<br />Cellular:+521 (55) 3493-9457<br /><br />
<a href="http://twitter.com/#!/BYGSTUDIO" target="_blank"><img src="img/twitter.png">Follow us in Twitter</a><br />
<a href="http://www.facebook.com/BygStudio" target="_blank"><img src="img/facebook.png">Follow us in Facebook</a></p></div>  
</div> 
</div>
</div>
</div>
