    ...
    <body>
        ...
        <div id="website">
            ...
            <div id="tab-two">
                ...
                <div id="items">	
                    <ul class="nav">
                        <li><a href="http://www.bygstudio.com/mainpage.php">HOME</a></li>
                        <li><a href="http://www.bygstudio.com/about.php">ABOUT</a></li>
                        <li><a href="http://www.bygstudio.com/contact.php">CONTACT</a></li>
                    </ul>
                </div>
                <!-- Wrapping Starts -->
